...
function NavInfoSubmit() {
    return (
        ...
        <p className="text-center font-light text-sm md:text-[24px]"> Almost done! We just need an email to send the discount to <br></br>(don’t worry, we won’t save this). </p>
        <div>
          <EmailSubmit />
        </div>
        <StakeBtnSubmit />
