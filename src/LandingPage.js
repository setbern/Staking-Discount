...
function LandingPage() {
  return (
    <><div className="flex flex-col items-center justify-center h-screen bg-gradient-br-tl">
      ...
      <h2 className="text-4xl mt-16 font-bold md:text-[50px]">
        <span className="text-myPurple">Badgers</span><span className="text-black">Build Discount</span>
      </h2>
      <div className='flex flex-col items-center mt-5'>
      <p className="mx-3 text-center font-light mt-2 md:text-[26px] text-[#424242]">
        Built by Badgers for the future builders - login & stake Badger 
        </p>
        <p className="mx-3 text-center font-light md:text-[26px] text-[#424242]">
