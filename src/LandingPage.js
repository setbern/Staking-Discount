...
function LandingPage() {
  return (
    <><div className="flex flex-col items-center justify-center min-h-screen bg-gradient-br-tl">
      <div className="flex relative items-center justify-center rounded-full h-[256px] w-[256px] bg-gradient-purple -mt-[400px]">
      ...
      <h2 className="text-4xl mt-16 font-bold md:text-[70px]">
        <span className="text-myPurple">Badgers</span><span className="text-black">Build Discount</span>
      </h2>
      <div className='flex flex-col items-center mt-5'>
      <p className="mx-3 text-center font-light mt-2 md:text-[38px] text-[#424242]">
        Built by Badgers for the future builders - login & stake Badger 
        </p>
        <p className="mx-3 text-center font-light lg:mx-20 xl:mx-64 md:text-[39px] text-[#424242]">
